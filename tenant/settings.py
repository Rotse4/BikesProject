...
SECRET_KEY = "django-insecure-yc8i%2e#co*^henzd_a$so@^!jwa97e^#9fz+mkqe*u1^nu9t-"
...
DATABASES = {
    "default": {
        ...
        "NAME": "railway",
        "USER": "postgres",
        "PASSWORD": os.environ["DB_PASSWORD_YO"],  # Ensure this is set
...
SPECTACULAR_SETTINGS = {
    ...
    "VERSION": "1.0.0",
    "SECURITY": [
        {"BearerAuth": []},  # Ensure this is correctly defined
    ],
    # "COMPONENTS": {
    #     "securitySchemes": {
    #         "BearerAuth": {
    #             "type": "http",
    #             "scheme": "bearer",
    #             "bearerFormat": "JWT",  # Optional but helps documentation clarity
    #         },
    #     },
    # },
    "SERVE_INCLUDE_SCHEMA": False,  # Ensure schema generation is enabled
}
